...
- There are enemies present in the game which the player can inflict damage on.
...
- The damage to enemies is allocated at random. So you will be dealing damage but just to a random enemy in the scene.
